...
<script>
        $(document).ready(function(){
            ...
            $(".delImg-sub").click(function(e){
                ...
                DelConfirm({'action': 'delImg', 'imgc_id': id});    
            })
                    ...
                    <div class="col-12">
                        <div class="bg-light rounded h-100 p-4">
                            ...
                            <div class="search d-flex align-items-center">
                                <h4 class="mx-3">แก่ไขข้อมูลเครื่องแต่งกาย</h4> 
                            </div>

                            <!-- form edit -->
                            <div class="">
                                <?php
                                    $sql="SELECT * FROM tb_cloting WHERE clo_id='$clo_id'";
                                ...
                                <form  enctype="multipart/form-data" id="frm-modal" name="frm">
                                    ...
                                    <input type="hidden" name="clo_id" id="clo_id" class="clo_id" value="<?php echo $row['clo_id'];?>">
                                    <div class="form-floating mb-3">
                                        <input type="text" name="clo_name" class="clo_name form-control" id="floatingInput" placeholder="" value="<?php echo $row['clo_name'];?>">
                                        <label for="floatingInput">ชื่อเครื่องแต่งกาย</label>
                                    </div>   
                                    
                                    <div class="form-floating mb-3">
                                        <textarea name="clo_detail" class="clo_detail form-control" style="height: 200px;" id="floatingTextarea" placeholder=""><?php echo $row['clo_detail'];?></textarea>
                                    ...
                                    <div class="form-floating d-flex mb-3">
                                        ...
                                        <div class="position-relative m-3">                                            
                                            <img class="rounded" src="img/cloting/<?php echo $row['imgc_name'];?>" style="height: 100px; width:100px;">  
                                            <a href="" class="delImg-sub" id="delImg-sub" data-id="<?=$row["imgc_id"];?>"><i class="fa-solid fa-circle-xmark fs-4 position-absolute top-0 start-100 translate-middle"></i></a>
                                    ...
                                    <div class="modal-footer">
                                        <a href="cloting.php"><button type="button" class="btn btn-secondary">ยกเลิก</button></a>
