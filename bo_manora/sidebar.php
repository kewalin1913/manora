            ...
            <nav class="navbar bg-light navbar-light">
                ...
                <a href="index.php" class="bg-primary ms-3 mb-3 px-4 py-1 border border-3 d-flex justifile-content-center  " style="width: 100%;border-radius:10px;">
                        ...
                        <div class="ms-3">
                            ...
                            <span class="text-light fs-6 text-primary">ประสิทธิ์ศิลป์ ดาวรุ่ง</span>
                        </div>
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="news.php" class="nav-item nav-link"><i class="fa-regular fa-newspaper me-2"></i> ข่าวประชาสัมพันธ์</a>                    
