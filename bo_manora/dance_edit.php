...
<script>
        $(document).ready(function(){
            ...
            $(".delImg-sub").click(function(e){
                ...
                DelConfirm({'action': 'delImg', 'imgd_id': id});    
            })
                    ...
                    <div class="col-12">
                        <div class="bg-light rounded h-100 p-4">
                            ...
                            <div class="search d-flex align-items-center">
                                <h4 class="mx-3">แก่ไขข้อมูลท่ารำ</h4> 
                            </div>

                            <!-- form edit -->
                            <div class="">
                                <?php
                                    $sql="SELECT * FROM tb_dance WHERE dan_id='$dan_id'";
                                ...
                                <form  enctype="multipart/form-data" id="frm-modal" name="frm">
                                    ...
                                    <input type="hidden" name="dan_id" id="dan_id" class="dan_id" value="<?php echo $row['dan_id'];?>">
                                    <input type="hidden" name="dan_clip" id="dan_clip" class="dan_clip" value="<?php echo $row['dan_clip'];?>">

                                    <div class="form-floating mb-3">
                                        <input type="text" name="dan_name" class="dan_name form-control" id="floatingInput" placeholder="" value="<?php echo $row['dan_name'];?>">
                                        <label for="floatingInput">ชื่อท่ารำ</label>
                                    </div>   
                                    
                                    <div class="form-floating mb-3">
                                        <textarea name="dan_detail" class="dan_detail form-control" style="height: 200px;" id="floatingTextarea" placeholder=""><?php echo $row['dan_detail'];?></textarea>
                                    ...
                                    <video width="320" height="200" controls>
                                        <source src="vdo/<?php echo $row['dan_clip'];?>" type="video/mp4">
                                    </video>
                                    ...
                                    <div class="form-floating d-flex mb-3">
                                        ...
                                        <div class="position-relative m-3">                                            
                                            <img class="rounded" src="img/dance/<?php echo $row['imgd_name'];?>" style="height: 100px; width:100px;">  
                                            <a href="" class="delImg-sub" id="delImg-sub" data-id="<?=$row["imgd_id"];?>"><i class="fa-solid fa-circle-xmark fs-4 position-absolute top-0 start-100 translate-middle"></i></a>
                                    ...
                                    <div class="NewInput mb-3 border" id="NewInput">
                                        <div class="mb-1 text-center d-flex justifile-center align-items-center">
                                            <input type="file" class="form-control my-2" id="formFileMultiple" name="dan_img[]" style="width: 75%;">
     ...
     <script type="text/javascript">
        ...
        $('#Add-InputFile').click(function(){
            NewRowAdd=          
                ...
                '<input type="file" class="form-control my-1" id="imgInput" name="dan_img[]" style="width: 75%;">'+
                '<img src="" class="img_adm mx-3" loading="lazy" width="50px" id="previewImg" alt="">'+
                '<button type="button" class="Del-InputFile btn btn-danger" id="Del-InputFile"><i class="fa-solid fa-xmark"></i></button>'+
                '</div>';
