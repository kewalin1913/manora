            ...
            <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-4 p-4">
                ...
                <div class="col">
                    <div class="card h-100">
                        ...
                        ?>
                            <img src="../bo_manora/img/dance/<?=$rowImg['imgd_name'];?>" class="card-img-top">
                        <?php }?>
                        <div class="card-body text-center">
                            <h5 class="card-title border border-info border-start-0 border-end-0 p-1 text-center"><?=$row['dan_name'];?></h5> 
                            <button class="btn btn-primary" style="--bs-btn-padding-y: .25rem; --bs-btn-padding-x: .5rem; --bs-btn-font-size: .75rem;"
                            onclick="window.location.href='dance_show.php?dan_id=<?=$row['dan_id'];?>'">อ่านต่อ</button> 
                        </div>
                    </div>                    
                </div>   
                <?php }?> 
