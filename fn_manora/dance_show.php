<?php
    ...
    if(isset($_GET['dan_id'])){
        $dan_id=$_GET['dan_id'];
        $tb = "tb_dance";
        $sql = "SELECT * FROM $tb WHERE dan_id = $dan_id";
        ...
        <div class="row row-cols-1 row-cols-sm-2">
            <div class="col col-md-3">
                <video width="300" controls autoplay>
                    <source src="../bo_manora/vdo/<?=$row['dan_clip'];?>" type="video/mp4">
                    Your browser does not support HTML video.
                </video>
            </div>
            <div class="col col-md-9">
                <h1 class="px-2 m-1 border-bottom"><?=$row['dan_name'];?></h1>
                <!-- <p class="px-3"><?=$row['dan_detail'];?></p> -->
                <div>
                    ...
                    ?>
                        <div class="col">
                            <div class="card h-100 shadow-sm">
                                <img src="../bo_manora/img/dance/<?=$rowimg['imgd_name'];?>" alt="" class="card-img">
                            </div>                            
                        </div>
                    <?php } ?>
                    </div>
