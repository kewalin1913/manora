    ...
    <!---------- Main Content ---------->
        ...
        <div class="container">
            ...
            <?php
                ...
                $resulttitle=$conn->query($sqlimg);
                $imgtitle=$resulttitle->fetch_assoc();
            ?>
            <div class="row row-cols-1 row-cols-sm-2">
                <div class="col">
                    <img src="../bo_manora/img/news/<?=$imgtitle['imgn_name'];?>" alt="" class="card-img rounded-3">
                </div>
                <div class="col">
                    <h1 class="px-2 m-1 border-bottom"><?=$row['news_title'];?></h1>
                    <p class="px-3"><?=$row['news_detail'];?></p>
                    ...
                    ?>
                        <div class="col">
                            <div class="card h-100 shadow-sm">
                                <img src="../bo_manora/img/news/<?=$rowimg['imgn_name'];?>" alt="" class="card-img">
                            </div>                            
                        </div>

                    <?php } ?>
                    </div>
                    <div class="footer border-top p-2">
                            ผู้โพสต์ : <?php echo $row['adm_name']."  ".$row['adm_lname'];?><br>
                            วันที่โพสต์ : <?=DateThai($row['news_post']);?>
                    </div>
                </div>
            </div> 
        </div>
