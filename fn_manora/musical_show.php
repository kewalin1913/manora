<?php
    ...
    if(isset($_GET['mus_id'])){
        $mus_id=$_GET['mus_id'];
        $tb = "tb_musical";
        $sql = "SELECT * FROM $tb WHERE mus_id = $mus_id";
    ...
    <!---------- Main Content ---------->
        ...
        <div class="container">
            ...
            <div class="row row-cols-1 row-cols-sm-2">
                <div class="col">
                    <div class="row row-cols-1 row-cols-sm-2 row-cols-lg-2 g-3 pt-4">
                    <?php
                    ...
                    ?>
                        <div class="col">
                            <div class="card h-100 shadow-sm">
                                <img src="../bo_manora/img/musical/<?=$rowimg['imgm_name'];?>" alt="" class="card-img">
                            </div>                            
                        </div>
                ...
                <div class="col bg-white rounded-4 shadow-sm py-3">
                    <h1 class="px-2 m-1 border-bottom"><?=$row['mus_name'];?></h1>
                    <p class="px-3"><?=$row['mus_detail'];?></p>
                </div>
            </div> 
        </div>
        <!-- Content End -->   
